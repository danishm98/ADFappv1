...
# Check if built_up_area is a string, blank, or None, and output it as is if it is
       ...
       # Shape 11: Table
        ...
        #shape_12.cell(2, 0).margin_top = Inches(0.02)
        #shape_12.cell(2, 1).margin_top = Inches(0.02)
        shape_12.cell(0,0).margin_top = Inches(0.03)
        ...
        # Set the internal margins for the text frames in the third row to zero
        shape_12.cell(2, 0).text_frame.margin_top = Inches(0)
        shape_12.cell(2, 0).text_frame.margin_bottom = Inches(0)
        shape_12.cell(2, 0).text_frame.margin_left = Inches(0)
        shape_12.cell(2, 0).text_frame.margin_right = Inches(0)
        
        shape_12.cell(2, 1).text_frame.margin_top = Inches(0)
        ...
        shape_12.rows[1].height = Inches(0.5)
        shape_12.rows[2].height = Inches(0.25)
        # Shape 13: Table
        ...
        # Clear any existing paragraphs
        text_frame.clear()
        lines = str(basis_project or "").strip().split('\n')
